...
namespace Skoggy.Grove.Physics
{
    public static class CollisionResolver
    {
        ...
        {
            const float percent = 0.2f; // usually 20% to 80%, correction to avoid sinking
        ...
        public static void Resolve(ref Manifold manifold)
        {
            ...
            var restitution = MathF.Min(manifold.ShapeA.Restitution, manifold.ShapeB.Restitution);
